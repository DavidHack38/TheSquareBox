...
<html>
	...
	<body>
		...
		<?php
			...
			echo ' <font color="red" size="4"> Vous êtes connecté sous le compte de ' . $user_info['pseudo'] . '</font> <br> --> <a class=\'link\' href="disconnect.php"> Se déconnecter </a> <br> <br>';
...
<?php 
				echo '<a class=\'link\' href="modify_logement.php?id_l=' . $nfo['id_logement'] . '"> Modifier ce logement </a> <br> <br> <br>';
			} // fin boucle while
		}
		else
		{
