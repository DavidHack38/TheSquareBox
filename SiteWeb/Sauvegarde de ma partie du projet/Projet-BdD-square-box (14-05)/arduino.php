...
//__Verifie si le dossier est vide______________________________________________________________________________________________________
		
		$dir = opendir($path);
		while (($contenu_dir = readdir($dir)) !== FALSE)
		{
			if (($contenu_dir != '.') AND ($contenu_dir != '..'))
			{
				++$counter;
			}
		}
