...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 10 Avril 2017 à 20:54
...
CREATE TABLE `informations` (
  ...
  `dimension_tot` varchar(255) DEFAULT NULL,
...
INSERT INTO `informations` (`primary_key_pls_ignore`, `id_of_user`, `id_logement`, `adresse1`, `adresse2`, `ville`, `code_postal`, `dimension_tot`, `prix`, `commentaire`, `date`, `heure`, `pic_id_user`, `pic_idl`, `pic_path`) VALUES
...
(27, 1, 'oui', 'cdt', 'Bruce', NULL, NULL, NULL, NULL, NULL, '10/04/2017', '18:38:24', '1', 'oui', NULL);
...
CREATE TABLE `mesures` (
  ...
  `save_increm_file` int(11) DEFAULT '0',
...
INSERT INTO `mesures` (`id_of_user`, `id_logement`, `save_increm_file`, `longueur_salon`, `largeur_salon`, `surface_salon`, `longueur_cuisine`, `largeur_cuisine`, `surface_cuisine`, `longueur_sdb`, `largeur_sdb`, `surface_sdb`, `longueur_chambre`, `largeur_chambre`, `surface_chambre`) VALUES
(1, 'ard_test', 1, '8.949', '17.11', '1474.00', '0.85', '55.5', '44.00', '0', '0', '0.00', '0', '0', '0.00');
...
--
ALTER TABLE `informations`
  MODIFY `primary_key_pls_ignore` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `mesures`
  MODIFY `id_of_user` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
