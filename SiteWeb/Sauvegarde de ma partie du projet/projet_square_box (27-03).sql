...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 27 Mars 2017 à 19:17
...
INSERT INTO `informations` (`primary_key_pls_ignore`, `id_user`, `id_logement`, `adresse1`, `adresse2`, `ville`, `code_postal`, `dimension`, `prix`, `commentaire`, `date`, `heure`, `pic_id_user`, `pic_idl`, `pic_path`) VALUES
(1, 5, 'Md', '458', '', 'apprieu', 25896, NULL, 55, 'srgfdg', '10/02/0255', '12:10', NULL, NULL, NULL),
(2, 2, 'A1', '458', '', 'apprieu', 25896, NULL, 55, 'srgfdg', '10/02/0255', '12:10', NULL, NULL, NULL),
(3, 2, 'A1', '458', '5896', 'apprieu', 25896, NULL, 55, 'srgfdg', '10/02/0255', '12:10', NULL, NULL, NULL);
...
(3, 'Zunkusem', 'jeremi04@hotmail.fr', '6b6277afcb65d33525545904e95c2fa240632660', 'default_profil.png', 'TRUE', 'FALSE'),
(4, 'yolopatalo', 'mailtest@oo.ii', 'df5fe22a5f8fb50cc3bd59f34a438bc6dddb52a3', 'default_profil.png', 'TRUE', 'FALSE'),
...
--
ALTER TABLE `informations`
  MODIFY `primary_key_pls_ignore` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
