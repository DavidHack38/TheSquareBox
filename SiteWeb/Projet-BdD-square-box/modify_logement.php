		...
		{			
			...
			if (isset($_POST['validation']))
			{
				if ($logement_info['id_of_user'] == $_SESSION['id_user'])
				{
					...
					");
					$req_upd-> execute();
					header('location: affichage.php?mode=aff');
				}
			}
//____________________________________________________________________________________________________
...
<html>
	...
	<body>
			...
			<div align="center"> <br>
				<h2 class="explic"> 
					<a class='btn' href='affichage.php?mode=aff'> <-- Retour </a> 
					&nbsp;&nbsp;Modifier le logement situé au <?php echo $logement_info['adresse1'] . ' à ' . $logement_info['ville'] . ' (id : ' . $logement_info['id_logement'] . ')'; ?> : </h2>
				...
				<form method="POST" action="" enctype="multipart/form-data">
					<table>
						...
						<tr>
							...
							<td>
								<input type="number" name="code_postal" id="code_postal" value="<?php if (isset($logement_info['code_postal'])) { echo  $logement_info['code_postal']; } ?>" placeholder="Code Postal">
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="number" name="dimension" id="dimension" value="<?php if (isset($logement_info['dimension'])) { echo  $logement_info['dimension']; } ?>" placeholder="Dimension" >
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="number" name="prix" id="prix" value="<?php if (isset($logement_info['prix'])) { echo  $logement_info['prix']; } ?>" placeholder="Prix">
							</td>
						</tr>
						<tr>
							<td align="right">
