...
//____________________________________________________________________________________________________
		...
		if (isset($_GET['id_user'], $_SESSION['id_user']) AND $_GET['id_user'] == $_SESSION['id_user'])
		{
			...
			<div class="moncadre">
				...
				<a href="index.php"> <img class="zoom" src="fichiers/images/favicon2_no-process.png"/> </a>
					...
					<nav id="navigation">
						...
						<?php if (isset($_SESSION['id_user'])) { echo '<li> <a id=\'active\' href=\'' . $profil_php .'\'> Profil </a> </li>';} ?>
...
<?php
			...
			if ($acc_valid['confirm_by_mail'] == 'FALSE')
			{
				...
				echo '<div class="message">
					Votre compte n\'a pas été validé ! Vérifier vos mails ! <br> 
			...
			if (isset($_SESSION['id_user']) AND $user_info['id_user'] == $_SESSION['id_user'])
			{
				...
				echo '<li> <a class=\'link\' href="affichage.php?mode=aff"> Voir mes logements </a> </li> <br>';
		...
		{ ?>
			...
			<html>
			<head>
				<?php head(); // fonction qui regroupe tout le head ?>
			...
			<?php
			echo '<br><br><br><br><br>';
			echo '<div align="center"> <font size="5" color="red"> Vous n\'êtes pas connecté ! <br> Redirection en cours ... </font> </div>';
